/**
  ...
  *          Provides temperature data via I2C2, used by freertos.c’s TempTask to update
...
/**
  ...
  * @details Reads the temperature register via I2C2 with DMA, returning the value in degrees
