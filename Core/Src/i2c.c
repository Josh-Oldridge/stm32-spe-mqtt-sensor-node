...
/**
  ...
  * @details This file implements I2C1 configuration for the STM32L496ZG-P Nucleo board in the
  *          CN0575 Single Pair Ethernet (SPE) board project. Configures I2C1 with DMA for
...
/** @brief Semaphore for I2C access synchronization, initialized in I2C2_InitSemaphore */
...
void I2C_InitSemaphore(void) {
    if (i2cSemaphore == NULL) {
        ...
        if (i2cSemaphore == NULL) {
            printf("I2C: Semaphore creation failed!\n");
        }
    }
}
...
/**
  ...
  * @details Logs I2C1 errors to LPUART1, triggered on communication failures with sensors.
  */
void HAL_I2C_ErrorCallback(I2C_HandleTypeDef *hi2c)
{
    if (hi2c->Instance == I2C1)
    {
        printf("I2C1: Error callback triggered!\n");
    }
}
/* USER CODE END 0 */
